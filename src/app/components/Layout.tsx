...
const Layout: FC<layoutInterface> = ({ backgroundColor, color, children, activePage, simple }) => {
   ...
   return (
      <div style={style} className="min-h-screen overflow-hidden relative">
         ...
         {!simple ? <main className={`min-w-[1400px] ${active ? "ml-[320px]" : "mx-auto"} pt-10 relative z-40`}>{children}</main> : children}
      </div>
   );
};
