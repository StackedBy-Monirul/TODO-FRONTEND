        ...
        <Modal.Header className="bg-gray-800 border-b border-gray-700 rounded-t-lg">
          <div className="flex items-center justify-between w-full">
            <input
              ...
              className="text-xl font-bold bg-transparent border-none outline-none text-white flex-1 mr-4"
            />
                  ...
                  {comments.map((comment) => (
                    <div key={comment._id} className="bg-gray-800 p-4 rounded-lg">
                      <div className="flex items-start space-x-3">
                        <Avatar
                          img={comment.user.avatar || `https://ui-avatars.com/api/?name=${comment.user.name}`}
                          size="sm"
                          rounded
                        />
